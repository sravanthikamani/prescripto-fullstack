                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            ...
                            <select onChange={e => setSpeciality(e.target.value)} value={speciality} className='border rounded px-2 py-2'>
                                <option value="Companion Animal Veterinarians(dogs,cats,birds)">
  Companion Animal Veterinarians (dogs, cats, birds)
</option>
<option value="Food Animal Veterinarians(cows,goats,sheeps,poultry)">
  Food Animal Veterinarians (cows, goats, sheeps, poultry)
</option>
<option value="Equine Veterinarians(horses)">
  Equine Veterinarians (horses)
</option>
<option value="Veterinary Surgeons(bone, soft tissue, orthopedic, etc.)">
  Veterinary Surgeons (bone, soft tissue, orthopedic, etc.)
</option>
<option value="Veterinary Dermatologists">
  Veterinary Dermatologists
</option>
<option value="Veterinary Ophthalmologists">
